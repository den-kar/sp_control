...
def get_data_check_min_h(data):
  ...
  if 'h/' not in data[MIN]:
    return (0 if isinstance(data[MAX], str) else data[MAX])
  ...
  if kw_date > df_row[LA_ENT]:
    if contract != df_row[CON_TYP]:
      ...
      try:
        ...
        print(name, contract, kw_date)
        print(df_ee.at[name, CON_TYP])
        print(repr(ex))
        raise ex
...
if __name__ == '__main__':
  ...
  parser.add_argument('-z', '--last_year', type=int, default=0, help=P_Z)
